...
<html lang="en">
<head>
    <title>OnlyBooks - About Us</title>
    <meta charset="UTF-8">
                    ...
                    <nav id="navbar">
                        <div class="main-menu stellarnav">
                            <ul class="menu-list">
                                ...
                                <li class="menu-item active"><a href="about.php" class="nav-link" data-effect="About">About</a></li>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <div class="team-member text-center">
                    ...
                    <figure>
                        <a href="#"><img src="images/content/images/team-member-007.png" alt="post" class="member-image"></a>
                    </figure>
            ...
            <div class="col-md-3 text-center">
                ...
                <div class="team-member text-center">
                    <figure>
                        <img src="images/content/images/team-member-006.jpg"post" class="member-image">
                    </figure>
                    <div class="member-details text-center">
                        <h4>Mr Joseph Wright</h4>
            ...
            <div class="col-md-3 text-center">
                ...
                <div class="team-member text-center">
                    <figure>
                        <img src="images/content/images/team-member-004.jpg" alt="post" class="member-image">
                    </figure>
                    <div class="member-details text-center">
                        <h4>Mr Michael Blacksmith</h4>
            ...
            <div class="col-md-3 text-center">
                ...
                <div class="team-member text-center">
                    <figure>
                        <img src="images/content/images/team-member-001.jpg" alt="post" class="member-image">
                    </figure>
                    <div class="member-details text-center">
                        <h4>Mrs Lora Inn</h4>
...
<section class="padding-large">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <img src="images/content/images/post-img3.jpg" alt="book-authors" class="align-right">
                <p>
